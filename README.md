...
The files I change are the [misc/net_utils.lua](https://github.com/ruotianluo/neuraltalk2_resnet/blob/master/misc/net_utils.lua), [misc/transforms.lua](https://github.com/ruotianluo/neuraltalk2_resnet/blob/master/misc/transforms.lua)(copy from [fb.resnet.torch](https://github.com/facebook/fb.resnet.torch)),  [misc/LSTM_Armour.lua](copy from .[attention-based-image-caption/src/misc/LSTM_Armour.lua](https://github.com/eriche2016/attention-based-image-caption/blob/master/src/misc/LSTM_Armour.lua)), and [train.lua](https://github.com/ruotianluo/neuraltalk2_resnet/blob/master/train.lua)
